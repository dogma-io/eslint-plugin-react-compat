...
```bash
git clone https://github.com/<USERNAME>/eslint-plugin-react-compat.git
cd eslint-plugin-react-compat
git remote add upstream https://github.com/dogma-io/eslint-plugin-react-compat.git
```

**SSH**

```bash
git clone git@github.com:<USERNAME>/eslint-plugin-react-compat.git
cd eslint-plugin-react-compat
git remote add upstream git@github.com:dogma-io/eslint-plugin-react-compat.git
```
...
[fork-repo]: https://github.com/dogma-io/eslint-plugin-react-compat#fork-destination-box
